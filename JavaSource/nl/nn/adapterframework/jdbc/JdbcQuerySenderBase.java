 ...
 *
 * Revision 1.57  2011/09/20 07:56:12  gerrit
 * used isNotEmpty instead of !=null
 *
 * Revision 1.56  2011/09/15 11:55:03  martijno
 * blobBase64Direction added for streamBlob
 *
 *
 * Revision 1.55  2011/08/09 10:07:00  gerrit
 * updated javadoc
 *
 * Revision 1.54  2011/08/09 10:02:04  gerrit
 * moved timeout to JdbcSenderBase
 * added blob stream facility
 *
 * Revision 1.53  2011/04/27 10:01:53  peter
 * used timeout attribute in getting connection too
 *
 * Revision 1.52  2011/04/13 08:38:03  gerrit
 * Indicate updatability of resultset explicitly using method-parameter
 * Blob and Clob support using DbmsSupport
 *
 * Revision 1.51  2011/03/04 15:02:42  sanne
 * Corrected timeout exception message (from ms to sec)
 *
 * Revision 1.50  2010/03/25 12:57:03  gerrit
 * added attribute closeInputstreamOnExit
 *
 * Revision 1.49  2010/01/28 09:47:04  peter
 * separate method for executing "other" queries
 *
 * Revision 1.48  2009/10/22 13:42:55  peter
 * added attribute rowIdSessionKey
 *
 * Revision 1.47  2009/10/09 13:26:20  peter
 * added default includeFieldDefinition (true) for querySenders
 *
 * Revision 1.46  2009/10/07 13:35:12  peter
 * added attribute includeFieldDefinition
 *
 * Revision 1.45  2009/09/07 13:16:39  gerrit
 * replaced a '&' by '&&'
 *
 * Revision 1.44  2009/08/14 13:21:20  peter
 * fixed bug in useNamedParams
 *
 * Revision 1.43  2009/08/14 07:19:02  peter
 * fixed bug in useNamedParams (not thread safe)
 *
 * Revision 1.42  2009/08/12 07:38:28  peter
 * added warning for useNamedParams
 *
 * Revision 1.41  2009/08/12 07:17:19  peter
 * added warning for useNamedParams
 *
 * Revision 1.40  2009/08/04 10:12:13  gerrit
 * corrected description of useNamedParams
 *
 * Revision 1.39  2009/07/17 12:39:00  peter
 * added attribute useNamedParams
 *
 * Revision 1.38  2009/04/01 08:23:44  peter
 * added timeout attribute
 *
 * Revision 1.37  2009/03/03 14:38:35  gerrit
 * added support to put byte array as blob
 *
 * Revision 1.36  2008/10/20 12:52:23  peter
 * added blobSmartGet attribute
 *
 * Revision 1.35  2008/06/24 07:57:43  gerrit
 * allocate larger buffer for package result
 *
 * Revision 1.34  2008/06/19 15:13:11  gerrit
 * added support for binary BLOBs
 * select binary BLOB as base64
 *
 * Revision 1.33  2008/05/15 14:35:18  gerrit
 * catch more exceptions
 *
 * Revision 1.32  2008/03/27 10:54:03  gerrit
 * cosmetic changes to javadoc
 *
 * Revision 1.31  2007/10/08 13:30:32  gerrit
 * changed ArrayList to List where possible
 *
 * Revision 1.30  2007/07/19 15:09:54  gerrit
 * handle charsets of BLOB and CLOB streams correctly
 *
 * Revision 1.29  2007/07/17 09:20:24  gerrit
 * fix typo
 *
 * Revision 1.28  2007/07/10 07:18:25  gerrit
 * support for loading streams to blobs and clobs
 *
 * Revision 1.27  2007/04/24 11:37:12  gerrit
 * added package execution feature
 *
 * Revision 1.26  2007/02/27 12:37:43  gerrit
 * corrected returned result for blob/clobs & do required trimming
 *
 * Revision 1.25  2006/12/13 16:25:56  gerrit
 * added attribute blobCharset
 *
 * Revision 1.24  2006/12/12 09:57:38  gerrit
 * restore jdbc package
 *
 * Revision 1.22  2006/11/06 13:02:31  gerrit
 * added attribute scalarExtended
 *
 * Revision 1.21  2006/02/09 10:42:56  gerrit
 * added clob-support (PL)
 *
 * Revision 1.20  2006/01/05 14:21:21  gerrit
 * updated javadoc
 *
 * Revision 1.19  2005/10/24 09:17:29  gerrit
 * separate statement for result query
 *
 * Revision 1.18  2005/10/19 10:45:18  gerrit
 * moved prepareStatement-met-columnlist to separate method, 
 * to avoid compilation problems when non JDBC 3.0 drivers are used
 *
 * Revision 1.17  2005/10/19 09:34:13  gerrit
 * moved getGeneratedKeys to separate method, 
 * to avoid compilation problems when non JDBC 3.0 drivers are used
 *
 * Revision 1.16  2005/10/18 07:09:32  gerrit
 * added updateBlob functionality
 * added trimSpaces feature
 *
 * Revision 1.15  2005/09/29 13:59:49  gerrit
 * provided attributes and handling for nullValue,columnsReturned and resultQuery
 *
 * Revision 1.14  2005/09/08 16:00:52  gerrit
 * make synchronous an attribute, default="true"
 *
 * Revision 1.13  2005/08/25 15:48:37  gerrit
 * close all jdbc-objects in finally clause
 *
 * Revision 1.12  2005/07/28 07:33:20  gerrit
 * close statement also for update-statements
 *
 * Revision 1.11  2005/07/19 12:36:32  gerrit
 * moved applyParameters to JdbcFacade
 *
 * Revision 1.10  2005/06/28 09:05:47  gerrit
 * explicit closing of resultset
 *
 * Revision 1.9  2005/06/02 13:48:16  gerrit
 * added 'scalar' attribute, to return a single value
 *
 * Revision 1.8  2005/04/26 15:20:34  gerrit
 * introduced JdbcSenderBase, with non-sql oriented basics
 *
 * Revision 1.7  2004/11/10 12:56:55  gerrit
 * corrected parameter setting routine
 *
 * Revision 1.6  2004/10/19 06:41:08  gerrit
 * modified parameter handling
 *
 * Revision 1.5  2004/04/08 16:12:16  uknown5
 * changed default value for maxRows to -1 (show All)
 *
 * Revision 1.4  2004/03/31 12:04:19  gerrit
 * fixed javadoc
 *
 * Revision 1.3  2004/03/26 10:43:07  johan
