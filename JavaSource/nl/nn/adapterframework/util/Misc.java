 ...
 *
 * Revision 1.33  2011/08/09 10:14:43  gerrit
 * renamed arrayListToString to listToString
 *
 * Revision 1.32  2011/07/07 12:13:51  peter
 * added method arrayListToString
 *
 * Revision 1.31  2010/11/12 15:11:14  peter
 * added isForceFixedForwardingByDefault
 *
 * Revision 1.30  2010/10/18 13:04:57  peter
 * modified UUID generation (2)
 *
 * Revision 1.29  2010/10/18 09:22:04  gerrit
 * modified UUID generation
 *
 * Revision 1.28  2010/03/25 12:58:28  gerrit
 * made close optional in readerToWriter
 *
 * Revision 1.27  2009/12/28 12:53:07  peter
 * cosmetic changes
 *
 * Revision 1.26  2009/12/24 08:27:55  peter
 * added methods getResponseBodySizeWarnByDefault and getResponseBodySizeErrorByDefault
 *
 * Revision 1.25  2009/11/12 12:36:04  peter
 * Pipeline: added attributes messageSizeWarn and messageSizeError
 *
 * Revision 1.24  2009/11/10 10:27:40  peter
 * method getEnvironmentVariables splitted for J2SE 1.4 and J2SE 5.0
 *
 * Revision 1.23  2009/01/29 07:02:29  peter
 * removed "j2c.properties resource path" from getEnvironmentVariables()
 *
 * Revision 1.22  2009/01/28 11:21:29  peter
 * added "j2c.properties resource path" to getEnvironmentVariables()
 *
 * Revision 1.21  2008/12/15 12:21:06  peter
 * added getApplicationDeploymentDescriptor
 *
 * Revision 1.20  2008/12/15 09:39:45  peter
 * getDeployedApplicationBindings: replaced property WAS_HOMES by user.install.root
 *
 * Revision 1.19  2008/12/08 13:06:58  peter
 * added createNumericUUID
 *
 * Revision 1.18  2008/11/25 10:17:10  peter
 * added getDeployedApplicationName and getDeployedApplicationBindings
 *
 * Revision 1.17  2008/09/08 15:00:23  gerrit
 * avoid NPE in getEnvironmentVariables
 *
 * Revision 1.16  2008/08/27 16:24:30  gerrit
 * made closeInput optional in streamToStream
 *
 * Revision 1.15  2007/09/05 13:05:44  gerrit
 * added function to copy context
 *
 * Revision 1.14  2007/06/12 11:24:24  gerrit
 * added getHostname()
 *
 * Revision 1.13  2005/10/27 08:43:36  gerrit
 * moved getEnvironmentVariables to Misc
 *
 * Revision 1.12  2005/10/17 11:26:58  gerrit
 * addded concatString and compression-functions
 *
 * Revision 1.11  2005/09/22 15:54:17  gerrit
 * added replace function
 *
 * Revision 1.10  2005/07/19 11:37:40  gerrit
 * added stream copying functions
 *
 * Revision 1.9  2004/10/26 15:36:36  gerrit
