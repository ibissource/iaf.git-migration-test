 ...
 *
 * Revision 1.22  2008/06/30 09:10:13  gerrit
 * removed functions that proved to be unreliable
 *
 * Revision 1.21  2008/02/22 14:34:00  gerrit
 * improved logging
 *
 * Revision 1.20  2008/02/06 16:03:25  gerrit
 * remove non-thrown exceptions
 *
 * Revision 1.19  2008/01/30 14:47:54  gerrit
 * Springification of inTransaction()
 *
 * Revision 1.18  2008/01/17 16:28:09  gerrit
 * Springifications
 *
 * Revision 1.17  2008/01/15 10:21:00  gerrit
 * adapt displayTransactionStatus to Spring
 *
 * Revision 1.16  2008/01/11 09:59:33  gerrit
 * changed attributed definitions to Spring's
 * removed some functions
 *
 * Revision 1.15  2007/12/10 10:23:12  gerrit
 * removed some functions
 *
 * Revision 1.14  2007/11/21 13:18:06  gerrit
 * added setRollBackOnly
 *
 * Revision 1.13  2007/08/10 11:22:29  gerrit
 * added non-argument inTransaction()
 *
 * Revision 1.12  2007/06/08 12:18:36  gerrit
 * do not rollback after exception on commit if status is already final
 *
 * Revision 1.11  2007/05/08 16:01:21  gerrit
 * removed stacktrace from debug-logging while obtaining user-transaction
 *
 * Revision 1.10  2007/02/12 14:12:03  gerrit
 * Logger from LogUtil
 *
 * Revision 1.9  2006/09/18 11:46:36  gerrit
 * lookup UserTransaction only when necessary
 *
 * Revision 1.8  2006/09/14 11:47:10  gerrit
 * optimized transactionStateCompatible()
 *
 * Revision 1.7  2006/08/21 15:14:49  gerrit
 * introduction of transaction attribute handling
 * configuration of user transaction url in appconstants.properties
 *
 * Revision 1.6  2005/09/08 15:58:15  gerrit
 * added logging
 *
 * Revision 1.5  2004/10/05 09:57:38  gerrit
 * made version public
 *
 * Revision 1.4  2004/03/31 15:03:26  gerrit
 * fixed javadoc
 *
 * Revision 1.3  2004/03/26 10:42:38  johan
 * added @version tag in javadoc
 *
 * Revision 1.2  2004/03/26 09:50:52  johan
 * Updated javadoc
 *
 * Revision 1.1  2004/03/23 17:14:31  gerrit
 * initial version
 *
 */
