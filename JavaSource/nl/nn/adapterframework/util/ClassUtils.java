 ...
 *
 * Revision 1.20  2010/12/13 13:30:06  gerrit
 * added more class-debug methods
 *
 * Revision 1.19  2010/02/10 13:47:53  gerrit
 * improved reflection methods
 *
 * Revision 1.18  2010/02/10 09:34:52  gerrit
 * added getDeclaredFieldValue()
 *
 * Revision 1.17  2010/01/28 14:45:42  gerrit
 * added some reflection methods
 *
 * Revision 1.16  2009/08/13 09:18:00  gerrit
 * added method invokers
 *
 * Revision 1.15  2008/08/18 11:22:03  gerrit
 * changed system.err.printline to log.error
 *
 * Revision 1.14  2007/12/10 10:22:30  gerrit
 * void NPE in classOf
 *
 * Revision 1.13  2007/09/13 12:39:05  gerrit
 * cosmetic improvement
 *
 * Revision 1.12  2007/09/10 11:20:15  gerrit
 * added default getResourceURL()
 *
 * Revision 1.11  2007/07/18 13:35:30  gerrit
 * try to get a resource as a URL
 * no replacemen of space to %20 for jar-entries
 *
 * Revision 1.10  2007/05/09 09:25:54  gerrit
 * added nameOf()
 *
 * Revision 1.9  2007/02/12 14:09:05  gerrit
 * Logger from LogUtil
 *
 * Revision 1.8  2006/09/14 11:44:51  gerrit
 * correctede logger definition
 *
 * Revision 1.7  2005/09/26 15:29:33  gerrit
 * change %20 to space and back
 *
 * Revision 1.6  2005/08/30 16:06:27  gerrit
 * escape spaces in URL using %20
 *
 * Revision 1.5  2005/08/18 13:34:19  gerrit
 * try to prefix resource with 'java:comp/env/', for TomCat compatibility
 *
 * Revision 1.4  2004/11/08 08:31:17  gerrit
