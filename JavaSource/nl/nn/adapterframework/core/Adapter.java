 ...
 *
 * Revision 1.2  2011/10/19 14:56:54  peter
 * do not print versions anymore
 *
 * Revision 1.1  2011/10/19 14:49:46  peter
 * Upgraded from WebSphere v5.1 to WebSphere v6.1
 *
 * Revision 1.63  2011/08/22 14:21:39  gerrit
 * removed unused methods
 *
 * Revision 1.62  2011/08/18 14:34:48  gerrit
 * moved pipe statistics iteration to PipeLine
 * modified interface for statistics
 *
 * Revision 1.61  2011/08/09 07:41:26  gerrit
 * improved result logging
 *
 * Revision 1.60  2011/06/27 15:15:51  gerrit
 * improved configWarnings
 *
 * Revision 1.59  2011/05/25 07:39:35  gerrit
 * collect cache statistics
 *
 * Revision 1.58  2010/09/13 13:34:25  gerrit
 * renamed configurePipes() into configure()
 * improved error logging
 *
 * Revision 1.57  2009/12/29 14:32:20  gerrit
 * modified imports to reflect move of statistics classes to separate package
 *
 * Revision 1.56  2009/11/11 13:14:50  peter
 * adjusted javadoc
 *
 * Revision 1.55  2009/10/15 14:28:31  peter
 * replaced requestReplyLogging attribute by msgLogLevel attribute
 *
 * Revision 1.54  2009/08/26 15:27:15  gerrit
 * support for separated adapter-only and detailed statistics
 *
 * Revision 1.53  2009/06/05 07:20:40  gerrit
 ...
 *
 * Revision 1.52  2009/03/19 14:07:45  peter
 * added numOfMessagesStartProcessingByHour
 *
 * Revision 1.51  2009/03/19 08:14:53  peter
 * added numOfMessagesStartProcessingByHour
 *
 * Revision 1.50  2009/02/24 14:25:37  gerrit
 * avoid NPE on wait statistics while iterating over statistics
 *
 * Revision 1.49  2008/09/22 13:28:45  gerrit
 * use CounterStatistics for counters
 * changed references to Hashtable to Map
 * output statistics in order of Pipes
 *
 * Revision 1.48  2008/09/04 12:02:27  gerrit
 * collect interval statistics
 *
 * Revision 1.47  2008/08/27 15:54:07  gerrit
 * added reset option to statisticsdump
 *
 * Revision 1.46  2008/08/12 15:31:13  gerrit
 * moved collection of receiver statistics to receiver
 *
 * Revision 1.45  2008/08/07 11:34:07  gerrit
 * removed references to old monitoring code
 *
 * Revision 1.44  2008/08/07 07:54:55  gerrit
 * modified for flexibile monitoring
 *
 * Revision 1.43  2008/06/19 11:08:59  gerrit
 * GALM message when exception caught starting adapter
 *
 * Revision 1.42  2008/06/18 12:27:43  gerrit
 * discern between severe errors and warnings (for monitoring)
 *
 * Revision 1.41  2008/05/21 10:56:09  gerrit
 * modified monitorAdapter interface
 * fixed NDC handling
 *
 * Revision 1.40  2008/05/14 09:33:30  gerrit
 * simplified methodnames of StatisticsKeeperIterationHandler
 * now implements interface HasStatistics
 *
 * Revision 1.39  2008/03/28 14:20:42  gerrit
 * simplify error messages
 *
 * Revision 1.38  2008/03/27 11:09:41  gerrit
 * avoid nested non-informative NDCs
 *
 * Revision 1.37  2008/01/03 15:40:19  gerrit
 * renamed start and stop threads
 * do not wait at end of start thread
 *
 * Revision 1.36  2007/12/28 12:01:00  gerrit
 * log error messages in request-reply logging
 *
 * Revision 1.35  2007/12/12 09:08:41  gerrit
 * added message class to monitor event from error
 *
 * Revision 1.34  2007/12/10 10:00:02  gerrit
 * added monitoring
 *
 * Revision 1.33  2007/10/10 09:35:28  gerrit
 * Direct copy from Ibis-EJB:
 * spring enabled version
 *
 * Revision 1.32  2007/10/08 12:15:38  gerrit
 * corrected date formatting
 *
 * Revision 1.31  2007/07/24 08:05:22  gerrit
 * added targetDesignDocument attribute
 *
 * Revision 1.30  2007/07/10 07:11:45  gerrit
 * logging improvements
 *
 * Revision 1.29  2007/06/26 12:05:34  gerrit
 * tuned logging
 *
 * Revision 1.28  2007/05/02 11:23:52  gerrit
 * added attribute 'active'
 *
 * Revision 1.27  2007/03/14 12:22:10  gerrit
 * log results in case of exception, too
 *
 * Revision 1.26  2007/02/12 13:44:09  gerrit
 * Logger from LogUtil
 *
 * Revision 1.25  2006/09/14 14:58:00  gerrit
 * added getPipeLine()
 *
 * Revision 1.24  2006/09/07 08:35:50  gerrit
 * added requestReplyLogging
 *
 * Revision 1.23  2006/08/22 12:50:17  gerrit
 * moved code for userTransaction to JtaUtil
 *
 * Revision 1.22  2006/02/09 07:55:15  gerrit
 * name, upSince and lastMessageDate in statistics-summary
 *
 * Revision 1.21  2005/12/28 08:34:46  gerrit
 * introduced StatisticsKeeper-iteration
 *
 * Revision 1.20  2005/10/26 13:16:14  gerrit
 * added second default for UserTransactionUrl
 *
 * Revision 1.19  2005/10/17 08:51:23  gerrit
 * made getMessageKeeper synchronized
 *
 * Revision 1.18  2005/08/17 08:12:45  peter
 * NDC updated
 *
 * Revision 1.17  2005/08/16 12:33:30  gerrit
 * added NDC with correlationId
 *
 * Revision 1.16  2005/07/05 12:27:52  gerrit
 * added possibility to end processing with an exception
 *
 * Revision 1.15  2005/01/13 08:55:15  gerrit
 * Make threadContext-attributes available in PipeLineSession
 *
 * Revision 1.14  2004/09/08 14:14:41  gerrit
 * adjusted error logging
 *
 * Revision 1.13  2004/08/19 07:16:21  unknown0
 * Resolved problem of hanging adapter if stopRunning was called just after the 
 * adapter was set to started
 *
 * Revision 1.12  2004/07/06 07:00:44  gerrit
 * configure now throws less exceptions
 *
 * Revision 1.11  2004/06/30 10:02:23  gerrit
 * improved error reporting
 *
 * Revision 1.10  2004/06/16 13:08:11  johan
 * Added configuration error when no pipeline was configured
 *
 * Revision 1.9  2004/06/16 12:34:46  johan
 * Added AutoStart functionality on Adapter
 *
 * Revision 1.8  2004/04/28 08:31:41  johan
 * Added getRunStateAsString function
 *
 * Revision 1.7  2004/04/13 11:37:13  johan
 * When the Adapter was in state "ERROR", it could not be stopped anymore. Fixed it.
 *
 * Revision 1.6  2004/04/06 14:52:52  johan
 * Updated handling of errors in receiver.configure()
 *
 * Revision 1.5  2004/03/30 07:29:53  gerrit
 * updated javadoc
 *
