 ...
 *
 * Revision 1.2  2012/06/12 15:08:29  jaco
 ...
 *
 * Revision 1.12  2008/01/29 15:39:55  gerrit
 * added support for idocs
 *
 * Revision 1.11  2007/10/03 08:35:01  gerrit
 * changed HashMap to Map
 *
 * Revision 1.10  2007/06/07 15:18:01  gerrit
 * now implements HasPhysicalDestination
 *
 * Revision 1.9  2006/01/05 13:59:07  gerrit
 * updated javadoc
 *
 * Revision 1.8  2005/12/28 08:42:17  gerrit
 * removed unused imports
 *
 * Revision 1.7  2005/08/10 12:44:20  gerrit
 * do close() if open() fails
 *
 * Revision 1.6  2005/08/08 09:42:29  gerrit
 * reworked SAP classes to provide better refresh of repository when needed
 *
 * Revision 1.5  2005/03/14 17:27:54  gerrit
 * increased logging
 *
 * Revision 1.4  2005/03/10 14:48:42  gerrit
 * removed trace setting
 *
 * Revision 1.3  2004/10/05 10:41:24  gerrit
 * removed unused imports
 *
 * Revision 1.2  2004/08/23 13:11:58  gerrit
 * updated JavaDoc
 *
 * Revision 1.1  2004/08/23 07:12:05  gerrit
 * renamed SapMessagePusher to SapListener
 *
 * Revision 1.4  2004/08/09 13:56:23  gerrit
 * changed ServiceClient to MessageHandler
 *
 * Revision 1.3  2004/07/19 09:45:03  gerrit
 * added getLogPrefix()
 *
 * Revision 1.2  2004/07/15 07:47:12  gerrit
 * changed IMessagePusher to IPushingListener
 *
 * Revision 1.1  2004/07/06 07:09:05  gerrit
 * moved SAP functionality to extensions
 *
 * Revision 1.2  2004/06/30 12:38:06  gerrit
 * included exceptionlistener
 *
 * Revision 1.1  2004/06/22 12:19:08  gerrit
