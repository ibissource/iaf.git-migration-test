 ...
 *
 * Revision 1.15  2011/01/26 14:42:56  gerrit
 * new style ProcessUtil
 *
 * Revision 1.14  2010/09/09 11:42:02  jaco
 * Removed double destinationName in javadoc
 *
 * Revision 1.13  2010/03/22 11:08:12  peter
 * moved message logging from INFO level to DEBUG level
 *
 * Revision 1.12  2010/03/10 14:30:06  peter
 * rolled back testtool adjustments (IbisDebuggerDummy)
 *
 * Revision 1.10  2009/09/07 13:14:02  gerrit
 * use log from ancestor
 *
 * Revision 1.9  2009/06/10 15:49:24  gerrit
 * added test for presence queueConnectionFactoryName, for fxf 2 compatibility
 *
 * Revision 1.8  2009/03/04 15:57:38  gerrit
 * added support for FXF 2.0
 * added local and remote filenames to fxf_init calls
 *
 * Revision 1.6  2008/09/04 12:05:25  gerrit
 * test for version of fxf
 *
 * Revision 1.5  2008/08/27 15:55:41  gerrit
 * added remote filename option
 *
 * Revision 1.4  2008/02/22 14:29:22  gerrit
 * implement ISender
 *
 * Revision 1.3  2008/02/21 12:42:56  gerrit
 * fixed default of script
 * options to delete or backup file after sending
 *
 * Revision 1.2  2008/02/19 09:39:27  gerrit
 * updated javadoc
 *
