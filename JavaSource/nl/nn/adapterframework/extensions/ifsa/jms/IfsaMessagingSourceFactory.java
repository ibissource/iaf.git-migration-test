 ...
 *
 * Revision 1.3  2011/11/30 13:51:44  peter
 ...
 *
 * Revision 1.2  2008/07/24 12:26:26  gerrit
 * added support for authenticated JMS
 *
 * Revision 1.1  2007/10/16 08:15:43  gerrit
 * introduced switch class for jms and ejb
 *
 * Revision 1.13  2007/10/08 12:17:00  gerrit
 * changed HashMap to Map where possible
 *
 * Revision 1.12  2007/09/05 15:46:37  gerrit
 * moved XA determination capabilities to IfsaConnection
 *
 * Revision 1.11  2007/08/10 11:08:59  gerrit
 * added functions to check XA capabilities
 *
 * Revision 1.10  2007/02/21 15:58:03  gerrit
 * add message for XA under v2.0
 *
 * Revision 1.9  2005/12/28 08:48:06  gerrit
 * removed unused imports
 *
 * Revision 1.8  2005/10/26 08:21:42  gerrit
 * renamed createJmsConnection() into createConnection()
 *
 * Revision 1.7  2005/10/20 15:34:09  gerrit
 * renamed JmsConnection into ConnectionBase
 *
 * Revision 1.6  2005/08/31 16:28:38  gerrit
 * report use of dynamic reply queues
 *
 * Revision 1.5  2005/07/28 07:30:25  gerrit
 * show XA status in log
 *
 * Revision 1.4  2005/07/19 12:33:58  gerrit
 * implements IXAEnabled 
 * polishing of serviceIds, to work around problems with ':' and '/'
 *
 * Revision 1.3  2005/06/20 09:13:40  gerrit
 * dynamic determination of provider URL
 *
 * Revision 1.2  2005/06/13 12:30:45  gerrit
 * ifsa 2.2 compatibilty connection
 *
 * Revision 1.1  2005/05/03 15:58:50  gerrit
