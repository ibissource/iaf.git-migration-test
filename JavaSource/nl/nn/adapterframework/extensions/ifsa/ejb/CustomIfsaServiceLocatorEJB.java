 ...
 *
 * Revision 1.1.2.6  2007/11/15 14:02:24  tim
 ...
 *
 * Revision 1.1.2.5  2007/11/15 12:54:50  tim
 * Add bit more logging
 *
 * Revision 1.1.2.4  2007/11/08 12:29:42  tim
 * Instantiate Logger instance using LogUtil
 *
 * Revision 1.1.2.3  2007/11/08 09:47:54  tim
 * Look up bean from JNDI instead of via service-lookup method (since our JNDI name is not an IFSA service id!)
 *
 * Revision 1.1.2.2  2007/11/02 11:48:36  tim
 * Add JavaDoc comment
 *
 * Revision 1.1.2.1  2007/11/02 11:47:06  tim
