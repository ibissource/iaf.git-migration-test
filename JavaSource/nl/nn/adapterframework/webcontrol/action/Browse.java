 ...
 *
 * Revision 1.23  2011/03/16 16:37:32  gerrit
 * use datetime parameters to improve browsing performance
 *
 * Revision 1.22  2010/01/04 15:05:47  peter
 * added label
 *
 * Revision 1.21  2009/12/23 17:10:23  gerrit
 * modified MessageBrowsing interface to reenable and improve export of messages
 *
 * Revision 1.20  2009/10/26 13:53:09  peter
 * added MessageLog facility to receivers
 *
 * Revision 1.19  2009/08/04 11:46:58  gerrit
 * work around IE 6 issue, that prevents exporting messages under HTTPS
 *
 * Revision 1.18  2009/04/28 11:36:31  gerrit
 * corrected dateClip handling
 *
 * Revision 1.17  2009/04/28 09:32:52  gerrit
 * added clip option to date filter
 *
 * Revision 1.16  2009/03/13 14:34:41  peter
 * added expiry date
 *
 * Revision 1.15  2009/01/02 10:27:14  peter
 * export function restored (unjust removed in v4.9.3)
 *
 * Revision 1.14  2008/12/10 17:05:50  gerrit
 * fixed bug in export selected messages; now a valid zip file is returned
 *
 * Revision 1.13  2008/11/06 10:23:14  peter
 * *** empty log message ***
 *
 * Revision 1.12  2008/08/12 16:04:34  gerrit
 * added skipMessages
 *
 * Revision 1.11  2008/08/06 16:42:18  gerrit
 * allow to search in message body text
 *
 * Revision 1.10  2008/06/24 08:00:39  gerrit
 * prepare for export of messages in zipfile
 *
 * Revision 1.9  2008/06/03 15:59:41  gerrit
 * improved parsing of start date
 *
 * Revision 1.8  2008/01/11 14:55:36  gerrit
 * filter on host and type, too
 *
 * Revision 1.7  2007/12/10 10:25:32  gerrit
 * rework
 *
 * Revision 1.6  2007/11/15 12:36:10  gerrit
 * configurable order for jdbc transactional storage browsing
 * + max number of messages
 *
 * Revision 1.5  2007/10/08 12:26:12  gerrit
 * corrected date formatting
 *
 * Revision 1.4  2007/09/24 13:05:02  gerrit
 * ability to download file, using correct filename
 *
 * Revision 1.3  2007/06/14 09:45:00  gerrit
 * strip slash from context path
 *
 * Revision 1.2  2007/05/29 11:13:25  gerrit
 * add message logs
 *
 * Revision 1.1  2005/09/29 14:57:11  gerrit
