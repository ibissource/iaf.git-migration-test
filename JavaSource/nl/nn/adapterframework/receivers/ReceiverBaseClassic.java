 ...
 * sync from HEAD
 *
 * Revision 1.9  2008/06/26 12:53:28  gerrit
 * fixed logstatement
 *
 * Revision 1.8  2008/05/21 10:51:12  gerrit
 * modified monitorAdapter interface
 *
 * Revision 1.7  2008/01/17 16:28:51  gerrit
 * use different displayTransactionStatus()
 *
 * Revision 1.6  2008/01/03 15:53:23  gerrit
 * improved logging
 *
 * Revision 1.5  2007/12/10 10:16:40  gerrit
 * fixed clearing of retryInterval
 *
 * Revision 1.4  2007/11/23 14:18:31  gerrit
 * progagate transacted attribute to Jms and Jdbc Listeners
 *
 * Revision 1.3  2007/10/23 13:07:35  tim
 * Fix another NPE when no inProcessStorage is defined
 *
 * Revision 1.2  2007/10/23 12:53:20  tim
 * Fix NPE when no error-storage and no inprocess-storage have been defined, but only an error-sender
 *
 * Revision 1.1  2007/10/16 12:40:36  gerrit
