 ...
 *
 * Revision 1.16  2009/01/14 10:54:58  gerrit
 * added fileTimeSensitive attribute
 *
 * Revision 1.15  2008/10/24 07:03:34  peter
 * outputDirectory attribute is optional instead of obliged
 *
 * Revision 1.14  2008/08/13 13:41:54  gerrit
 * prepare to react better on stop command
 *
 * Revision 1.13  2008/07/15 12:50:51  gerrit
 * added excludeWildcard attribute
 *
 * Revision 1.12  2008/04/03 07:18:06  gerrit
 * now implements HasPhysicalDestination
 *
 * Revision 1.11  2008/02/28 16:24:31  gerrit
 * use PipeLineSession.setListenerParameters()
 *
 * Revision 1.10  2008/02/19 09:41:09  gerrit
 * updated javadoc
 *
 * Revision 1.9  2008/02/15 13:59:30  gerrit
 * added attributes processedDirectory, numberOfBackups, overwrite and delete
 *
 * Revision 1.8  2007/10/03 08:59:50  gerrit
 * changed HashMap to Map
 *
 * Revision 1.7  2007/07/26 16:24:31  gerrit
 * cosmetic changes
 *
 * Revision 1.6  2007/07/10 15:18:40  gerrit
 * fixed typo
 *
 * Revision 1.5  2007/05/21 12:21:36  gerrit
 * added createInputDirectory attribute
 *
 * Revision 1.3  2007/02/12 14:03:44  gerrit
 * Logger from LogUtil
 *
 * Revision 1.2  2006/09/25 13:21:43  gerrit
 * cosmetic reorganization of code
 *
 * Revision 1.1  2006/08/23 11:35:56  gerrit
