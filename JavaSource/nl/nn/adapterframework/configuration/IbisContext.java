 ...
 * Revision 1.11  2012-09-07 13:15:17  jaco
 ...
 *
 * Revision 1.6  2009/11/05 14:20:31  peter
 * renamed property transaction.strategy to application.server.type
 *
 * Revision 1.5  2009/10/30 15:31:07  peter
 * Run IBIS on Tomcat
 *
 * Revision 1.4  2009/10/29 15:41:52  peter
 * Run IBIS on Tomcat
 *
 * Revision 1.3  2009/10/29 13:32:07  peter
 * Run IBIS on Tomcat
 *
 * Revision 1.2  2008/02/25 10:10:59  gerrit
 * removed JMX server starting
 *
 * Revision 1.1  2008/02/13 12:52:21  gerrit
 * renamed IbisMain to IbisContext
 *
 * Revision 1.8  2008/02/08 09:47:28  gerrit
 * cosmetic changes
 *
 * Revision 1.7  2007/12/28 08:54:23  gerrit
 * made fields private
 *
 * Revision 1.6  2007/10/16 13:18:03  tim
 * Allow creating of Spring Factory without creating instance of IbisMain
 *
 * Revision 1.5  2007/10/16 13:07:39  tim
 * Refactor so that creation of Spring factory is in seperate method, which can be called externally
 *
 * Revision 1.4  2007/10/16 09:12:28  tim
 * Merge with changes from EJB branch in preparation for creating new EJB brance
 *
 * Revision 1.3  2007/10/15 13:06:47  gerrit
 * added configuration field (TvdL)
 * Revision 1.1.2.10  2007/10/15 13:01:00  tim
 * Suppress message that Ibis internal MBean server is running when it isn't
 *
 * Revision 1.1.2.9  2007/10/15 08:35:29  tim
 * Fix NPE in ConfigurationServlet
 *
 * Revision 1.1.2.8  2007/10/12 14:29:31  tim
 * Several fixes and improvements to get EJB deployment mode running
 *
 * Revision 1.1.2.7  2007/10/10 14:30:40  gerrit
