 ...
 *
 * Revision 1.24  2012/08/23 11:57:43  jaco
 * Updates from Michiel
 *
 * Revision 1.23  2012/06/01 10:52:48  jaco
 * Created IPipeLineSession (making it easier to write a debugger around it)
 *
 * Revision 1.22  2011/11/30 13:51:51  peter
 * adjusted/reversed "Upgraded from WebSphere v5.1 to WebSphere v6.1"
 *
 * Revision 1.1  2011/10/19 14:49:48  peter
 * Upgraded from WebSphere v5.1 to WebSphere v6.1
 *
 * Revision 1.20  2010/12/15 15:15:13  gerrit
 * enable ackmode setting in configuration
 *
 * Revision 1.19  2010/01/28 15:00:03  gerrit
 * renamed 'Connection' classes to 'MessageSource'
 *
 * Revision 1.18  2010/01/20 08:23:58  peter
 * bugfix - avoid NPE in getDeliveryCount
 *
 * Revision 1.17  2009/07/28 12:44:24  gerrit
 * enable SOAP over JMS
 *
 * Revision 1.16  2008/09/01 15:13:33  gerrit
 * made common baseclass for pushing and pulling jms listeners
 *
 * Revision 1.15  2008/08/27 16:15:13  gerrit
 * introduced delivery count calculation
 *
 * Revision 1.14  2008/02/28 16:23:18  gerrit
 * use PipeLineSession.setListenerParameters()
 *
 * Revision 1.13  2008/02/19 09:39:44  gerrit
 * updated javadoc
 *
 * Revision 1.12  2008/02/08 09:48:29  gerrit
 * reintroduced rollback for states other than commitOnState
 *
 * Revision 1.11  2008/02/06 16:37:02  gerrit
 * disabled use of commitOnState
 *
 * Revision 1.10  2008/01/29 12:20:57  gerrit
 * added support for thread number control
 *
 * Revision 1.9  2008/01/11 09:45:08  gerrit
 * copy jmsTransacted to jmsConnector
 *
 * Revision 1.8  2008/01/03 15:51:56  gerrit
 * rework port connected listener interfaces
 *
 * Revision 1.7  2007/11/23 14:22:04  gerrit
 ...
 *
 * Revision 1.6  2007/11/22 13:29:52  gerrit
 * some more logging
 *
 * Revision 1.5  2007/11/22 09:08:56  gerrit
 * update from ejb-branch
 *
 * Revision 1.1.2.6  2007/11/15 10:35:24  tim
 * Add methods new in implemented interface
 *
 * Revision 1.1.2.5  2007/11/06 13:15:10  tim
 * Move code putting properties into threadContext from 'getIdFromRawMessage' to 'populateThreadContext'
 *
 * Revision 1.1.2.4  2007/11/06 12:43:56  tim
 * Improve some JavaDoc
 *
 * Revision 1.1.2.3  2007/11/06 12:41:17  tim
 ...
 *
 * Revision 1.1.2.2  2007/11/06 12:29:54  tim
 * Rename parameter 'context' to 'threadContext', in keeping with other code
 *
 * Revision 1.1.2.1  2007/11/06 09:39:14  tim
