 ...
 *
 * Revision 1.49  2012/08/23 11:57:43  jaco
 * Updates from Michiel
 *
 * Revision 1.48  2012/05/04 06:42:40  jaco
 * Added correlationIdToHexPrefix
 *
 * Revision 1.47  2012/04/26 10:57:02  jaco
 * Added "milliseconds" to javadoc/ibis description MessageTimeToLive
 *
 * Revision 1.46  2012/04/02 08:42:20  jaco
 * Added correlationIdToHex
 *
 * Revision 1.45  2011/11/30 13:51:51  peter
 * adjusted/reversed "Upgraded from WebSphere v5.1 to WebSphere v6.1"
 *
 * Revision 1.1  2011/10/19 14:49:48  peter
 * Upgraded from WebSphere v5.1 to WebSphere v6.1
 *
 * Revision 1.43  2011/10/04 09:55:27  gerrit
 * use jndiContextPrefix
 *
 * Revision 1.42  2011/03/17 08:12:19  gerrit
 * separate method extractMessageBody()
 *
 * Revision 1.41  2010/02/02 14:34:49  peter
 * separate method for getting connectionfactory info
 *
 * Revision 1.40  2010/01/28 14:58:42  gerrit
 * renamed 'Connection' classes to 'MessageSource'
 *
 * Revision 1.39  2009/09/17 08:21:13  gerrit
 * fixed timeout handling of JmsSender
 *
 * Revision 1.38  2009/09/09 14:34:48  gerrit
 * fixed forced target client setting in secondary send() method
 *
 * Revision 1.37  2009/08/20 12:12:33  gerrit
 * added generic getStringFromRawMessage
 *
 * Revision 1.36  2009/07/28 12:37:36  gerrit
 * updated javadoc
 *
 * Revision 1.35  2008/07/24 12:20:00  gerrit
 * added support for authenticated JMS
 *
 * Revision 1.34  2008/05/15 14:55:07  gerrit
 * make connection available to descender classes
 *
 * Revision 1.33  2008/02/22 14:31:48  gerrit
 * added Selector to getPhysicalDestinationName
 *
 * Revision 1.32  2008/02/19 09:39:44  gerrit
 * updated javadoc
 *
 * Revision 1.31  2007/11/23 14:47:55  gerrit
 * fix check on XA connection factories
 *
 * Revision 1.30  2007/11/23 14:17:36  gerrit
 * remove XA connectionfactories
 *
 * Revision 1.29  2007/10/16 09:12:27  tim
 * Merge with changes from EJB branch in preparation for creating new EJB brance
 *
 * Revision 1.26.4.4  2007/10/12 09:09:07  tim
 * Fix compilation-problems after code-merge
 *
 * Revision 1.26.4.3  2007/10/10 14:30:42  gerrit
 * synchronize with HEAD (4.8-alpha1)
 *
 * Revision 1.28  2007/10/10 08:42:39  gerrit
 * added isUseTopicFunctions()
 *
 * Revision 1.27  2007/09/24 13:03:24  gerrit
 * removed unused code
 *
 * Revision 1.26  2007/05/23 09:14:49  gerrit
 * use alternate connectionfactoryname, if appropriate one not set
 *
 * Revision 1.25  2006/10/13 08:14:27  gerrit
 * update javadoc
 *
 * Revision 1.24  2006/02/23 10:48:51  gerrit
 * fixed typo in name of setTopicConnectionFactoryName
 *
 * Revision 1.23  2005/12/20 16:59:26  gerrit
 * implemented support for connection-pooling
 *
 * Revision 1.22  2005/10/24 15:15:15  gerrit
 * made sessionsArePooled configurable via appConstant 'jms.sessionsArePooled'
 * added getLogPrefix()
 *
 * Revision 1.21  2005/10/20 15:44:49  gerrit
 * modified JMS-classes to use shared connections
 * open()/close() became openFacade()/closeFacade()
 *
 * Revision 1.20  2005/08/02 06:49:17  gerrit
 * deliveryMode to String and vv
 * method to send to (reply) destination with msgtype, priority and timetolive
 *
 * Revision 1.19  2005/03/31 08:14:29  gerrit
 * added todo for setting delivery mode
 *
 * Revision 1.18  2004/10/05 10:41:59  gerrit
 * removed unused imports
 *
 * Revision 1.17  2004/08/23 13:08:36  gerrit
 * updated JavaDoc
 *
 * Revision 1.16  2004/08/18 09:20:58  unknown0
 * Make getConnection and closeConnection thread safe
 *
 * Revision 1.15  2004/08/16 11:27:56  gerrit
 * changed timeToLive back to messageTimeToLive
 *
 * Revision 1.14  2004/08/16 09:26:30  gerrit
 * changed messageTimeToLive to timeToLive
 *
 * Revision 1.13  2004/06/16 12:25:52  johan
 ...
 *
 * Revision 1.11  2004/05/03 07:11:32  johan
 * Updated message selector behaviour
 *
 * Revision 1.10  2004/04/26 09:58:06  johan
