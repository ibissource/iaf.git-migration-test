 ...
 * Revision 1.47  2012-12-13 10:41:59  peter
 * added type xmldatetime
 *
 * Revision 1.46  2012/12/12 09:46:53  peter
 * made corrections for the maxLength, minInclusive and maxInclusive attributes
 *
 * Revision 1.45  2012/12/11 13:19:59  peter
 * added maxLength, minInclusive and maxInclusive attributes
 *
 * Revision 1.44  2012/01/04 10:50:50  peter
 * added removeNamespaces attribute
 *
 * Revision 1.43  2011/11/30 13:52:03  peter
 * adjusted/reversed "Upgraded from WebSphere v5.1 to WebSphere v6.1"
 *
 * Revision 1.1  2011/10/19 14:49:50  peter
 * Upgraded from WebSphere v5.1 to WebSphere v6.1
 *
 * Revision 1.41  2011/02/21 17:56:51  gerrit
 * cosmetic improvement in toString()
 *
 * Revision 1.40  2010/09/10 09:23:58  gerrit
 * restored some javadoc
 *
 * Revision 1.39  2010/09/07 15:55:14  jaco
 * Removed IbisDebugger, made it possible to use AOP to implement IbisDebugger functionality.
 *
 * Revision 1.38  2010/08/20 07:54:18  peter
 * 'fixeddate' variable only available in stub mode
 *
 * Revision 1.37  2010/07/12 12:51:13  gerrit
 * allow to specfiy namespace prefixes to be used in XPath-epressions
 *
 * Revision 1.36  2010/03/10 14:30:06  peter
 * rolled back testtool adjustments (IbisDebuggerDummy)
 *
 * Revision 1.34  2009/11/20 10:18:17  peter
 * facility to override fixeddate
 *
 * Revision 1.33  2009/09/07 13:26:07  gerrit
 * replaced a '&' by '&&'
 *
 * Revision 1.32  2009/08/18 13:29:02  peter
 * added 'fixeddate' variable
 *
 * Revision 1.31  2009/06/09 09:13:39  peter
 * added 'hostname' variable
 *
 * Revision 1.30  2009/04/16 13:56:33  peter
 * added hidden attribute
 *
 * Revision 1.29  2008/10/23 14:16:51  peter
 * XSLT 2.0 made possible
 *
 * Revision 1.28  2008/07/14 17:22:15  gerrit
 * support for debugging
 *
 * Revision 1.27  2008/02/28 16:23:39  gerrit
 * added type timestamp
 *
 * Revision 1.26  2008/01/11 09:45:50  gerrit
 * added type domdoc
 *
 * Revision 1.25  2007/10/08 13:31:49  gerrit
 * changed ArrayList to List where possible
 *
 * Revision 1.24  2007/08/03 09:08:25  gerrit
 * moved tp configuration to TransformerPool
 *
 * Revision 1.23  2007/06/14 08:49:04  gerrit
 * support for parameter type=number
 *
 * Revision 1.22  2007/05/24 11:52:46  gerrit
 * updated javadoc
 *
 * Revision 1.21  2007/05/24 09:54:00  gerrit
 * fixed parsing of date-types
 *
 * Revision 1.20  2007/05/16 11:45:18  gerrit
 * support for date & type types, (first use: jdbc)
 *
 * Revision 1.19  2007/05/09 09:26:47  gerrit
 * fixed node-support
 *
 * Revision 1.18  2007/05/08 15:59:53  gerrit
 * added type=node support
 *
 * Revision 1.17  2007/02/12 13:59:42  gerrit
 * Logger from LogUtil
 *
 * Revision 1.16  2006/11/06 08:19:13  gerrit
 * added value-attribute as fixed-value
 *
 * Revision 1.15  2005/10/24 09:59:24  unknown2
 * Add support for pattern parameters, and include them into several listeners,
 * senders and pipes that are file related
 *
 * Revision 1.14  2005/10/17 11:43:34  gerrit
 * namespace-awareness configurable
 *
 * Revision 1.13  2005/08/11 14:57:00  gerrit
 * improved handling of default values for empty transformation results
 *
 * Revision 1.12  2005/06/02 11:45:56  gerrit
 * fixed version string
 *
 * Revision 1.11  2005/06/02 11:44:48  gerrit
 * return current input value if no xslt, xpath or sessionkey are specified
 *
 * Revision 1.10  2005/04/26 09:33:45  gerrit
 * different handling of empy transform-result, so that it is null instead of an empty string
 *
 * Revision 1.9  2005/03/07 11:10:05  johan
 * Javadoc geupdate
 *
 * Revision 1.8  2005/01/13 08:08:33  gerrit
 * Xslt parameter handling by Maps instead of by Ibis parameter system
 *
 * Revision 1.7  2004/10/25 08:32:56  gerrit
 * parameters for parameters
 *
 * Revision 1.6  2004/10/19 15:27:19  gerrit
 * moved transformation to pool
 *
 * Revision 1.5  2004/10/19 13:50:04  gerrit
 * dual action parameters: allows to use session-variable as transformer-input
 *
 * Revision 1.4  2004/10/19 08:09:31  gerrit
 * omit xml declaration
 *
 * Revision 1.3  2004/10/14 16:04:28  gerrit
 * improved logging
 *
 * Revision 1.2  2004/10/12 15:06:48  gerrit
 * added asCollection() method
 *
 * Revision 1.1  2004/10/05 09:51:17  gerrit
 * moved to package parameters
 * added getValue()
 *
 * Revision 1.5  2004/08/26 09:04:47  gerrit
